...
* WebSocket: [https://github.com/folm/insight-api-folm#web-socket-api](https://github.com/folm/insight-api-folm#web-socket-api)
* API: [https://github.com/folm/insight-api-folm#instantsend-transactions](https://github.com/folm/insight-api-folm#instantsend-transactions)
...
By default, the Folm Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Folm Core daemon:
