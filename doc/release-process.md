...
* Update translations, see [translation_process.md](https://github.com/folm/folm/blob/master/doc/translation_process.md#syncing-with-transifex)
...
### Folm Core maintainers/release engineers, update (commit) version in sources
...
- Announce the release:
  ...
  - Release on Folm forum: https://www.folm.org/forum/topic/official-announcements.54/
...
- Notify flare so that he can start building [the PPAs](https://launchpad.net/~folm.org/+archive/ubuntu/folm)
