...
### Send 25000 FLM to New Addresses

Send exactly 25000 FLM to each new address created above.
...
Copy the masternode private key and correspondig collateral output transaction that holds the 25000 FLM.

*Note: The masternode priviate key is **not** the same as a wallet private key. **Never** put your wallet private key in the masternode.conf file. That is almost equivalent to putting your 25000 FLM on the remote server and defeats the purpose of a hot/cold setup.*
...
If you generated a new masternode private key, you will need to update the remote `folm.conf` files.

Shut down the daemon and then edit the file.

```nano .folmcore/folm.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `folm.conf` file.
...
and comparing with the official explorer at https://explorer.folm.org/chain/Folm
...
Search your Masternodes on https://folmninja.pl/masternodes.html
