...
//
// The Masternode Class. For managing the Darksend process. It contains the input of the 25000 FLM, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 25000 FLM - checking if valid masternode)
