 ...
 *
 *   // network
 *   CFolmNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.folm.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CFolmNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: FolmNetwork
// //   -- signature requirements : Key1(User)
// class CFolmNetworkVariable : public CGovernanceObject
// {
// private:
