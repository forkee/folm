...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "FolmNetwork") type = FolmNetwork;
    if(strType == "FolmNetworkVariable") type = FolmNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == FolmNetwork) s = "FolmNetwork";
    if(type == FolmNetworkVariable) s = "FolmNetworkVariable";
