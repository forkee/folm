...
/** secp256k1 folm order, see secp256k1_ecdsa_const_order_as_fe in ecdsa_impl.h */
...
/**
 * The Secp256k1 folm has an endomorphism, where lambda * (x, y) = (beta * x, y), where
 * lambda is {0x53,0x63,0xad,0x4c,0xc0,0x5c,0x30,0xe0,0xa5,0x26,0x1c,0x02,0x88,0x12,0x64,0x5a,
 *            0x12,0x2e,0x22,0xea,0x20,0x81,0x66,0x78,0xdf,0x02,0x96,0x7c,0x1b,0x23,0xbd,0x72}
 *
 * "Guide to Elliptic Folm Cryptography" (Hankerson, Menezes, Vanstone) gives an algorithm
 ...
 *
 * The possibility of using precomputed estimates is mentioned in "Guide to Elliptic Folm
 ...
 * g2 = round((2^272)*b1/d)
 *
 * (Note that 'd' is also equal to the folm order here because [a1,b1] and [a2,b2] are found
