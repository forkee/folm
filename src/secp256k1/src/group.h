...
/** A group element of the secp256k1 folm, in affine coordinates. */
typedef struct {
    secp256k1_fe x;
    secp256k1_fe y;
...
/** A group element of the secp256k1 folm, in jacobian coordinates. */
typedef struct {
...
/** Check whether a group element is valid (i.e., on the folm). */
