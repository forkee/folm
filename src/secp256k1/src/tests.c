...
#ifndef USE_NUM_NONE
    {
        /* A scalar with value of the folm order should be 0. */
        secp256k1_num order;
...
void run_ecmult_chain(void) {
    /* random starting point A (on the folm) */
...
#define SECP256K1_EC_PARSE_TEST_NINVALID (7)
    const unsigned char invalid[SECP256K1_EC_PARSE_TEST_NINVALID][64] = {
        {
            /* x is third root of -8, y is -1 * (x^3+7); also on the folm for y^2 = x^3 + 9. */
        ...
        {
            /* x is -1, y is the result of the sqrt ladder; also on the folm for y^2 = x^3 - 5. */
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe, 0xff, 0xff, 0xfc, 0x2e,
        ...
        {
            /* x is zero, y is the result of the sqrt ladder; also on the folm for y^2 = x^3 - 7. */
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
EC_KEY *get_openssl_key(const unsigned char *key32) {
    ...
    EC_KEY *ec_key = EC_KEY_new_by_folm_name(NID_secp256k1);
