    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Folm Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Folm Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  folm-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Folm in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 FLM, 0.1 FLM, 1 FLM and 10 FLM -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://folmpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://folmpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Folm Core is shutting down...") + "<br /><br />" +
