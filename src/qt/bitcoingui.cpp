...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and folm: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Folm Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Folm Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Folm Core help message to get a list with possible Folm Core command-line options"));
