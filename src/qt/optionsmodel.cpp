...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("nPrivateSendAmount")) {
        ...
        if (!settings.contains("nAnonymizeFolmAmount"))
            ...
            settings.setValue("nPrivateSendAmount", settings.value("nAnonymizeFolmAmount").toInt());
    }
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in folm.cpp during shotdown to also remove the window positions
