    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("FLM-light"), QVariant("light"));
    ui->theme->addItem(QString("FLM-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("FLM-green"), QVariant("drkblue"));
    ui->theme->addItem(QString("FLM-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("FLM-traditional"), QVariant("trad"));
