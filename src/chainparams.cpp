...
{
    const char* pszTimestamp = "Time 1/31/2018: Square made an illustrated children's story to explain bitcoin";
...
public:
    CMainParams() {
        ...
        // Folm addresses start with 'C'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,28);
        // Folm script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Folm private keys start with '7' or 'A'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,151);
        // Folm BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Folm BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        ...
        strSporkPubKey = "ae70cf886cced72758bc62cbce08b618ee9297b9f78001a15f1db2a108a7482b62273d3d8a5653cbe6c049045945b069f82a253e49f761ae2351ef90f2c071a3a0";

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x00000c9048baaa666e4809285190c16b05ee2daa28bc00c3d40c00dce0b104f8")),
            1517422753, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        vAlertPubKey = ParseHex("5fb987fad596743e0693d4eb36b26dcd5bed95dde43126d54648a16a31c2f6b47ac5fd2f6f728319902ac21dcfbb0bcd195f2c40e05cde8b36ce05c5837b392481");
        nDefaultPort = 42246;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("folm.io",  "testdnsseed.folm.io"));

        // Testnet Folm addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet Folm script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Folm BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Folm BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        ...
        strSporkPubKey = "625bbe660eec3f9a8c77693386b5c020db550689c766633648115a19ffde8d8d4d948c5a9bd089c268aa3a85013fa981e55ee2ac86f9dfd0df851adcc8e6fdda49";
...
public:
    CRegTestParams() {
        ...
        // Regtest Folm addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Folm script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Folm BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Folm BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Folm BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
};
